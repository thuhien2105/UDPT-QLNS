<header class="o_navbar">
    <nav class="o_main_navbar" data-command-category="disabled"><a href="#" class="o_menu_toggle hasImage"
            title="Home menu" aria-label="Home menu" data-hotkey="h"><svg xmlns="http://www.w3.org/2000/svg"
                class="o_menu_toggle_icon pe-none" width="14px" height="14px" viewBox="0 0 14 14">
            ...
            </svg><img class="o_menu_brand_icon d-none d-lg-inline position-absolute start-0 h-100 ps-1 ms-2"
                ...
                alt="Gifts"><span class="o_menu_brand d-none d-md-flex ms-3 pe-0">Gifts</span></a>
        <div class="o_menu_sections d-none d-md-flex flex-grow-1 flex-shrink-1 w-0" role="menu">
            <a href="#menu_id=341&amp;action=471" class="dropdown-item o_nav_entry" role="menuitem" tabindex="0"
                data-hotkey="1" data-menu-xmlid="hr_attendance.menu_hr_attendance_view_attendances"
                data-section="341">Gifts</a>
        </div>
        @include('page.header')
