<header class="o_navbar">
    <nav class="o_main_navbar" data-command-category="disabled">
        <a href="/" class="o_menu_toggle hasImage" title="Home menu" aria-label="Home menu" data-hotkey="h"
            style="position: relative"><svg xmlns="http://www.w3.org/2000/svg" class="o_menu_toggle_icon pe-none"
            ...
            </svg><img class="o_menu_brand_icon d-lg-inline position-absolute start-0 h-100 ps-1 ms-2"
                ...
                alt="Approvals" /><span class="o_menu_brand d-md-flex ms-3 pe-0">Approvals</span></a>
        <div class="o_menu_sections d-md-flex flex-grow-1 flex-shrink-1 w-0" role="menu">
            <div class="o-dropdown dropdown o-dropdown--no-caret">
                <a href="/approvals" type="button" class="dropdown-toggle fw-normal" data-hotkey="1" tabindex="0"
                    aria-expanded="false" data-menu-xmlid="approvals.approvals_approval_menu">
                    <span data-section="301">New request</span>
                </a>
            </div>
            <div class="o-dropdown dropdown o-dropdown--no-caret">
                <a href="/approvals/list" type="button" class="dropdown-toggle fw-normal" data-hotkey="1"
