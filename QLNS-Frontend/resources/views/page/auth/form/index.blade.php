                                ...
                                <div class="oe_title">
                                    <h1>
                                        <div name="name" class="o_field_widget o_required_modifier o_field_char"><input
                                                class="o_input" id="name_0" type="text" autocomplete="off" disabled
                                    ...
                                    <div class="o_inner_group grid col-lg-6">
                                        <div class="o_wrap_field d-flex d-sm-contents flex-column mb-3 mb-sm-0">
                                            ...
                                            <div class="o_cell o_wrap_input flex-grow-1 flex-sm-grow-0 text-break"
                                                ...
                                                <div name="dob"
                                                    ...
                                                    <input class="o_input" id="dob_0" type="text" disabled
                                        ...
                                        <div class="o_wrap_field d-flex d-sm-contents flex-column mb-3 mb-sm-0">
                                            ...
                                            <div class="o_cell o_wrap_input flex-grow-1 flex-sm-grow-0 text-break"
                                                ...
                                                <div name="address"
                                                    class="o_field_widget o_required_modifier o_field_char">
                                                    <input class="o_input" id="address_0" type="text" disabled
                                                        autocomplete="off" placeholder="e.g. Brussels">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="o_wrap_field d-flex d-sm-contents flex-column mb-3 mb-sm-0">
                                            <div
                                                class="o_cell o_wrap_label flex-grow-1 flex-sm-grow-0 w-100 text-break text-900">
                                                <label class="o_form_label" for="phone_number_0">Phone_number</label>
                                            </div>
                                            <div class="o_cell o_wrap_input flex-grow-1 flex-sm-grow-0 text-break"
                                                style="width: 100%;">
                                                <div name="phone_number"
                                                    class="o_field_widget o_required_modifier o_field_char">
                                                    <input class="o_input" id="phone_number_0" type="text" disabled
                                                        autocomplete="off" placeholder="e.g. Brussels">
                                                </div>
                                            </div>
                                        </div>
